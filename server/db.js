...
const createArrayOfWork = (minionId) => {
	const model = findDataArrayByName('work');
	const arrayOfWork = model.data.filter((work) => {
		return work.id === minionId;
	});
	return arrayOfWork;
};

const createError = (text, code) => {
...
// cd Desktop/Projekty/Codecademy/Boss\ Machine/
